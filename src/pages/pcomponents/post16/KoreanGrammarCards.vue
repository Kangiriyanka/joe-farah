...
const grammarRules= [{
    ...
    explanation: `하는 is used to describe or modify (e.g., '하는 일' = work that one does), while 한다는 is for reporting what someone said or does (e.g., '한다는 말' = the statement that one does it). It's akin to 'it's said that' or 'reportedly'. For the last one, take with a grain of salt, but 하다는 is less common in everyday conversation; you'd see it mainly in definitions or abstract discussions of concepts.`,
    blocks: [{

         id: 1,
         title: "하는",
         tip: "State facts",
         sentences: [["성공하는 사람은 자신을 믿는다.", "People who succeed believe in themselves."], ["방을 깨끗이 히는 것은 집중력에 도움이 된다.", "Having a clean room improves focus."],]
        }, 
        ...
        sentences: [["나는 자신을 믿는 사람은 반드시 성공한다는 것을 믿는다.", "I believe that that those who succeed believe in themselves."],
         ["최근 연구에 따르면, 방을 깨끗이 한다는 것이 집중력에 좋다고 한다.", "According to a recent study, having a clean is beneficial to concentration."]
    ...
    {id: 2,
    title: "인가요/ 나요",
    explanation: "Both are used as conversation softeners for questions with the latter being exclusively for verbs. 인가요 is often seen with yes/no state questions while 나요 has a more inquisitive/curious tone to it. Ideally, you shouldn't overthink it ⁠— it comes naturally.",
    blocks: [{
         id: 1,
    ...
    situation and could expect the listener's response. 던가 indicates \
     the speaker's attempt to recall forgotten information. It's always interesting ask native speakers about this, because there's never a clear-cut answer.",
    blocks: [{
         id:1,
         title: "더라",
         tip: "Talk about a personal experience",
         sentences: [["나는 일본 장마철은 정말 싫더라고요.", "I don't like the rainy season in Japan at all."], ["지난 주 인터뷰 때문에 걱정되더라고요.","I experienced nervousness from my interview last week. (literally)"]]
        }, {
        id: 2,
        title: "더니",
        ...
        id: 3,
        title: "던데",
        tip: "Elicit a response from the listener, confirm your statement",
